...
class CalculatorPage:
    def __init__(self, driver):
        ...
        self.button_7 = (By.CSS_SELECTOR, "button[data-value='7']")
        self.button_plus = (By.CSS_SELECTOR, "button[data-value='+']")
        self.button_8 = (By.CSS_SELECTOR, "button[data-value='8']")
        self.button_equals = (By.CSS_SELECTOR, "button[data-value='=']")
